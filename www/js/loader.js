...
function loadDrawing(/*string*/ url, /*string*/ id, dataJSON, /*calibrate int */ calibrate) {
    $.ajax({
        url: 'js/' + url + '.pjs',
        dataType: 'html',
        success: function(data) {
            ...
            loader[url].layout(dataJSON, calibrate);
        }
    });
}
...
*/
		loadDrawing('drawing1', 'canvas1', dataJSON.fBA, 1);
    	loadDrawing('drawing2', 'canvas2', dataJSON.sA, 0);


	}
	catch(err) {
		console.log("input not JSON or error");
	}
}
...
$(document).ready(function() {
    ...
    loadDrawing('drawing1', 'canvas1', dataJSON.fBA, 2);
    loadDrawing('drawing2', 'canvas2', dataJSON.sA, 2);
});
...
/*
		...
		console.log(dataJSON.fBA[11]);
*/
		loadDrawing('drawing1', 'canvas1', dataJSON.fBA, 0);
    	loadDrawing('drawing2', 'canvas2', dataJSON.sA, 0);
